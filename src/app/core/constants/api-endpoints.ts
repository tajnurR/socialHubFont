...
export enum ApiEndpoint {
  ...
  INSTAGRAM_OAUTH_EXCHANGE = '/integrations/instagram/oauth/exchange',
  INSTAGRAM_AUTHORIZATION_URL = '/integrations/instagram/oauth/authorization-url',
  INSTAGRAM_OAUTH_CALLBACK = '/integrations/instagram/oauth/callback',
  INSTAGRAM_OAUTH_CONNECT = '/integrations/instagram/connect',
  INSTAGRAM_OAUTH_CONNECT_ACCOUNTS = '/integrations/instagram/connect/accounts',
  ...
  FACEBOOK_CREDENTIAL_CONFIG_BY_ID = '/integrations/facebook/credentials/configs/:id',
